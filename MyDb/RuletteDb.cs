...
namespace Rulette.MyDb {
    public class RuletteDb : DbContext {
        ...
        private Task<bool> TaskAddNewItem(Item item, string userId) {
            return Task.Run(() => {
                var db = this;
                var user = db.User
        ...
        public async Task<bool> AddNewItemAsync(Item item, string userId) {
            return await TaskAddNewItem(item, userId);
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            //    .HasKey(item => new { item.InventoryId, item.ItemListId });
            //modelBuilder.Entity<InventoryItem>()
            //    .HasKey(item => item.ItemId);
            //modelBuilder.Entity<Bets>()
            //    .HasKey(item => item.BetId);
